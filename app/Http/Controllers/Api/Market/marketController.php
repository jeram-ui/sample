...
class marketController extends Controller
{
    ...
    {  
        ...
        // $item = tbl_market_bill::where('status','Active')->get();
    ...
    public function subBuilding($id)
    {
        $list = DB::select('call '.$this->lgu_db.'.spl_display_floor_block_joy(?)',array($id));
        return response()->json(new JsonResponse($list));
    }

    public function marketMasterlist(Request $request)
    {
        $barangay = "All";
        $type = "All";
        $tenant = "All";
    ...
    public function marketDelinquency(Request $request)
    {
        $all = "%";
        $person = "Person";
        $billing = "%";
