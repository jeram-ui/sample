...
namespace App\Http\Controllers\Api\TrisikadPermit;
...
class trisikadController extends Controller
{
    private $lgu_db;
    private $hr_db;
    private $trk_db;
    ...
    {
      $list = DB::select('Call '.$this->lgu_db.'.trisikad_requirements_zoe()');
      return response()->json(new JsonResponse($list));
    }
    public function trisikadlistdisplay( Request $request)
    {
    ...
    {
        //Billing
        $fees= DB::select('Call '.$this->lgu_db.'.ebplo_display_accounts_jho(17)');
 ...
 public function printTrisikadmasterlist(Request $request)
 {
   ...
   try {
     $main=$request->main;
       ...
       $html_content = '
             ' . $logo . ' 
       <h3 align="center">TRISIKAD PERMIT MASTER LIST</h3>
       <table>
       <tr>
 ...
 public function printTrisikadPermit(Request $request)
 {
