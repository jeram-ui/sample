...
class clientController extends Controller
{
    ...
    public function show()
    {
        ...
        ->select('*',db::raw("TRIM(CASE WHEN `save_type` = 'ClientPerson' THEN CONCAT(IFNULL(`prefix`,''),`fname`,' ',IFNULL(`mname`,''),' ',IFNULL(`lname`,''),' ',IFNULL(`suffix`,''))
        ELSE `company_name`
         END) as name"))
        ->where('status','ACTIVE')
        ->whereIn('save_type', ['ClientPerson', 'ClientCompany'])->get();
