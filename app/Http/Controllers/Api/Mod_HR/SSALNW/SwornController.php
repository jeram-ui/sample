            ...
            $form = array(
                ...
                'Fname'=>$form['Fname'],
                  'Firstname'=>$form['Firstname'],
                    ...
                    'spouse_fname'=>$form['spouse_fname'],
                    'spouse_mname'=>$form['spouse_mname'],
                    'spouse_lname'=>$form['spouse_lname'],
    ...
    <br />
        ...
        <table width="100%">
            <tr>
                ...
                <td style="border-bottom: 1px solid black; font-size:8pt" width="40%" align="center">'.$swornData->spouse_lname.', &nbsp; &nbsp;&nbsp;&nbsp; '.$swornData->spouse_fname.' &nbsp; &nbsp;&nbsp;&nbsp; '.$swornData->spouse_mname.'.</td>
                <td width="5.5%"> </td>
