Public Class frmXraySputum
                ...
                For x As Integer = 0 To .Columns.Count - 1
                    Select Case .Columns(x).Caption
                        ...
                        Case "Date of Exam"
                            ...
                            .Splits(0).DisplayColumns(x).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                        Case "Cause"
                            .Splits(0).DisplayColumns(x).Width = 200
                            .Splits(0).DisplayColumns(x).HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                            .Splits(0).DisplayColumns(x).Style.VerticalAlignment = C1.Win.C1TrueDBGrid.AlignVertEnum.Center
                            .Splits(0).DisplayColumns(x).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
    ...
    Private Sub frmXraySputum_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Load_data()
    End Sub
    Sub Load_data()
        DataGridPhysical.DataSource = DataSource("Call cvl_get_xray_history('" & _type & "','" & _busID & "','" & _ppID & "','" & Date.Now.Year & "')")
    End Sub
End Class