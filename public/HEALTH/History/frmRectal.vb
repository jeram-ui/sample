Public Class frmRectal
    ...
    Private Sub frmRectal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Load_data()
    End Sub
    Sub Load_data()
        DataGridPhysical.DataSource = DataSource("Call cvl_get_rectal_history('" & _type & "','" & _busID & "','" & _ppID & "','" & Date.Now.Year & "')")
    End Sub
End Class